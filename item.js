$(function() {
  ...
  var info = [
    ...
    {category: 1,series: 99,obtain: 4,make: "モモ x10</p><p>もくざい x5",image: "FtrFruitsChairPeach_Remake_0_0",name: "モモのチェア",get: get4},
    {category: 2,series: 99,obtain: 4,make: "モモ x10</p><p>やわらかいもくざい x4",image: "FtrFruitsBox_Remake_0_0",name: "モモのビックリばこ",get: get4},
    {category: 4,series: 99,obtain: 4,make: "モモ x20",image: "RoomTexWallPeach00",name: "モモのかべがみ",get: get4},
    {category: 4,series: 99,obtain: 4,make: "モモ x6",image: "RugOtherPeachM00",name: "モモのラグ",get: get4},
    {category: 5,series: 99,obtain: 4,make: "モモ x7",image: "UmbrellaPeach0Cropped",name: "モモのかさ",get: get4},
    {category: 5,series: 99,obtain: 4,make: "モモ x5",image: "CapHatPeach0",name: "モモのぼうし",get: get4},
    {category: 5,series: 99,obtain: 4,make: "モモ x8",image: "TopsTexOnepieceAlineNPeach0",name: "モモのふく",get: get4},
    {category: 1,series: 99,obtain: 1,make: "ナシ x10</p><p>もくざい x5",image: "FtrFruitsClosetLR_Remake_0_0",name: "ナシのクロゼット",get: get1},
    {category: 1,series: 99,obtain: 1,make: "ナシ x10</p><p>やわらかいもくざい x6",image: "FtrFruitsBedS_Remake_0_0",name: "ナシのベッド",get: get1},
    {category: 4,series: 99,obtain: 1,make: "ナシ x20",image: "RoomTexWallPear00",name: "ナシのかべがみ",get: get1},
    {category: 4,series: 99,obtain: 1,make: "ナシ x6",image: "RugOtherPearM00",name: "ナシのラグ",get: get1},
    {category: 5,series: 99,obtain: 1,make: "ナシ x7",image: "UmbrellaPear0Cropped",name: "ナシのかさ",get: get1},
    {category: 5,series: 99,obtain: 1,make: "ナシ x5",image: "CapHatPear0",name: "ナシのぼうし",get: get1},
    {category: 5,series: 99,obtain: 1,make: "ナシ x8",image: "TopsTexOnepieceAlineNPear0",name: "ナシのふく",get: get1},
    {category: 1,series: 99,obtain: 7,make: "りんご x10</p><p>もくざい x4",image: "FtrFruitsChairApple_Remake_0_0",name: "リンゴのチェア",get: get7},
    {category: 1,series: 99,obtain: 7,make: "りんご x10</p><p>てっこうせき x2",image: "FtrFruitsTV_Remake_0_0",name: "リンゴのテレビ",get: get7},
    {category: 4,series: 99,obtain: 7,make: "りんご x20",image: "RoomTexWallApple00",name: "リンゴのかべがみ",get: get7},
    {category: 4,series: 99,obtain: 7,make: "りんご x6",image: "RugOtherAppleM00",name: "リンゴのラグ",get: get7},
    {category: 5,series: 99,obtain: 7,make: "りんご x7",image: "UmbrellaApple0Cropped",name: "リンゴのかさ",get: get7},
    {category: 5,series: 99,obtain: 7,make: "りんご x5",image: "CapHatApple0",name: "リンゴのぼうし",get: get7},
    {category: 5,series: 99,obtain: 7,make: "りんご x8",image: "TopsTexOnepieceAlineNApple0",name: "リンゴのふく",get: get7},
    {category: 2,series: 99,obtain: 6,make: "ヤシのみ x1",image: "FtrCoconutjuice",name: "ココナッツジュース",get: get6},
    {category: 1,series: 99,obtain: 6,make: "ヤシのみ x4</p><p>もくざい x4</p><p>ねんど x4",image: "FtrPalmtreelamp_Remake_0_0",name: "パームツリーランプ",get: get6},
    {category: 3,series: 99,obtain: 6,make: "ヤシのみ x1</p><p>ざっそう x5",image: "FtrPlanterPalm",name: "ヤシのウォールプランター",get: get6},
    {category: 2,series: 99,obtain: 2,make: "りんご x1</p><p>ナシ x1</p><p>さくらんぼ x1</p><p>オレンジ x1</p><p>モモ x1",image: "FtrFruitbasket",name: "フルーツバスケット",get: get2},
    {category: 2,series: 99,obtain: 2,make: "りんご x2</p><p>ナシ x2</p><p>さくらんぼ x2</p><p>オレンジ x2</p><p>モモ x2</p><p>ヤシのみ x2",image: "FtrFruitswater",name: "フルーツウォーターサーバー",get: get2},
    {category: 3,series: 99,obtain: 2,make: "りんご x2</p><p>ナシ x1</p><p>さくらんぼ x3</p><p>オレンジ x3</p><p>モモ x1",image: "FtrDoorOrnamentWreathFruit",name: "フルーツのリース",get: get2},
    ...
    {category: 1,series: 99,obtain: 1,make: "あかいチューリップ x5</p><p>やわらかいもくざい x3",image: "FtrFlowerSurprisedbox_Remake_0_0",name: "チューリップのビックリばこ",get: get1},
    {category: 1,series: 99,obtain: 3,make: "あかいバラ x10</p><p>もくざい x5",image: "FtrFlowerBedW_Remake_0_0",name: "バラのベッド",get: get3},
    {category: 1,series: 99,obtain: 4,make: "きいろいパンジー x5</p><p>かたいもくざい x3",image: "FtrFlowerTableS_Remake_0_0",name: "パンジーのテーブル",get: get4},
    {category: 2,series: 99,obtain: 7,make: "むらさきのヒヤシンス x5</p><p>ねんど x3",image: "FtrFlowerLamp_Remake_0_0",name: "ヒヤシンスのランプ",get: get7},
    {category: 1,series: 99,obtain: 2,make: "しろいユリ x5</p><p>てっこうせき x3</p><p>もくざい x3",image: "FtrFlowerRecordplayer_Remake_0_0",name: "ユリのレコードプレーヤー",get: get2},
    ...
    {category: 3,series: 99,obtain: 8,make: "ピンクのキク x3</p><p>むらさきのキク x3</p><p>あかいキク x3",image: "FtrDoorOrnamentWreathMumMix",name: "ファンシーなキクのリース",get: get8},
    {category: 3,series: 99,obtain: 8,make: "みどりのキク x10",image: "FtrDoorOrnamentWreathMumRare",name: "ナチュラルなキクのリース",get: get8},
    ...
    {category: 3,series: 99,obtain: 8,make: "あかいチューリップ x3</p><p>きいろいチューリップ x3</p><p>しろいチューリップ x3",image: "FtrDoorOrnamentWreathTulip",name: "チューリップのリース",get: get8},
    ...
    {category: 3,series: 99,obtain: 8,make: "くろいチューリップ x10",image: "FtrDoorOrnamentWreathTulipRare",name: "ダークなチューリップのリース",get: get8},
    {category: 3,series: 99,obtain: 8,make: "あかいバラ x3</p><p>しろいバラ x3</p><p>きいろいバラ x3",image: "FtrDoorOrnamentWreathRose",name: "バラのリース",get: get8},
    {category: 3,series: 99,obtain: 8,make: "オレンジのバラ x3</p><p>ピンクのバラ x3</p><p>きいろいバラ x3",image: "FtrDoorOrnamentWreathRoseMix",name: "ファンシーなバラのリース",get: get8},
    {category: 3,series: 99,obtain: 8,make: "くろいバラ x3</p><p>むらさきのバラ x6",image: "FtrDoorOrnamentWreathRoseRare",name: "ダークなバラのリース",get: get8},
    ...
    {category: 3,series: 99,obtain: 8,make: "きいろいパンジー x3</p><p>しろいパンジー x3</p><p>あかいパンジー x3",image: "FtrDoorOrnamentWreathPansy",name: "パンジーのリース",get: get8},
    {category: 3,series: 99,obtain: 8,make: "あかきいろパンジー x3</p><p>あおいパンジー x3</p><p>きいろいパンジー x3",image: "FtrDoorOrnamentWreathPansyMix",name: "ポップなパンジーのリース",get: get8},
    {category: 3,series: 99,obtain: 8,make: "むらさきのパンジー x10",image: "FtrDoorOrnamentWreathPansyRare",name: "クールなパンジーのリース",get: get8},
    {category: 3,series: 99,obtain: 8,make: "しろいヒヤシンス x3</p><p>あかいヒヤシンス x3</p><p>きいろいヒヤシンス x3",image: "FtrDoorOrnamentWreathHyacinth",name: "ヒヤシンスのリース",get: get8},
    ...
    {category: 3,series: 99,obtain: 8,make: "しろいユリ x3</p><p>あかいユリ x3</p><p>きいろいユリ x3",image: "FtrDoorOrnamentWreathYuri",name: "ユリのリース",get: get8},
    {category: 3,series: 99,obtain: 8,make: "オレンジのユリ x3</p><p>ピンクのユリ x3</p><p>きいろいユリ x3",image: "FtrDoorOrnamentWreathYuriMix",name: "ファンシーなユリのリース",get: get8},
    {category: 3,series: 99,obtain: 8,make: "くろいユリ x10",image: "FtrDoorOrnamentWreathYuriRare",name: "ダークなユリのリース",get: get8},
    ...
    {category: 5,series: 99,obtain: 8,make: "あかいチューリップ x2</p><p>きいろいチューリップ x2</p><p>しろいチューリップ x1",image: "CapOrnamentTulip1",name: "チューリップのかんむり",get: get8},
    {category: 5,series: 99,obtain: 8,make: "むらさきチューリップ x2</p><p>ピンクのチューリップ x2</p><p>オレンジのチューリップ x1",image: "CapOrnamentTulip2",name: "チューリップのかんむり・シック",get: get8},
    {category: 5,series: 99,obtain: 8,make: "くろいチューリップ x5",image: "CapOrnamentTulip3",name: "チューリップのかんむり・ダーク",get: get8},
    {category: 5,series: 99,obtain: 8,make: "あかいバラ x2</p><p>きいろいバラ x2</p><p>しろいバラ x2",image: "CapOrnamentRose1",name: "バラのかんむり",get: get8},
    {category: 5,series: 99,obtain: 8,make: "ピンクのバラ x3</p><p>オレンジのバラ x3",image: "CapOrnamentRose2",name: "バラのかんむり・キュート",get: get8},
    {category: 5,series: 99,obtain: 8,make: "むらさきのバラ x3</p><p>くろいバラ x3",image: "CapOrnamentRose3",name: "バラのかんむり・シック",get: get8},
    {category: 5,series: 99,obtain: 8,make: "あおいバラ x6",image: "CapOrnamentRose4",name: "バラのかんむり・ブルー",get: get8},
    {category: 5,series: 99,obtain: 8,make: "きんのバラ x6",image: "CapOrnamentRose5",name: "バラのかんむり・ゴールド",get: get8},
    {category: 5,series: 99,obtain: 8,make: "あかいパンジー x2</p><p>きいろいパンジー x2</p><p>しろいパンジー x2",image: "CapOrnamentPansy1",name: "パンジーのかんむり",get: get8},
    {category: 5,series: 99,obtain: 8,make: "あかきいろパンジー x3</p><p>あおいパンジー x3",image: "CapOrnamentPansy2",name: "パンジーのかんむり・クール",get: get8},
    {category: 5,series: 99,obtain: 8,make: "むらさきのパンジー x6",image: "CapOrnamentPansy3",name: "パンジーのかんむり・パープル",get: get8},
    {category: 5,series: 99,obtain: 8,make: "あかいヒヤシンス x4</p><p>きいろいヒヤシンス x2</p><p>しろいヒヤシンス x2",image: "CapOrnamentHyacinth1",name: "ヒヤシンスのかんむり",get: get8},
    {category: 5,series: 99,obtain: 8,make: "あおいヒヤシンス x4</p><p>ピンクのヒヤシンス x2</p><p>オレンジのヒヤシンス x2",image: "CapOrnamentHyacinth2",name: "ヒヤシンスのかんむり・クール",get: get8},
    {category: 5,series: 99,obtain: 8,make: "むらさきのヒヤシンス x6",image: "CapOrnamentHyacinth3",name: "ヒヤシンスのかんむり・パープル",get: get8},
    {category: 5,series: 99,obtain: 8,make: "あかいユリ x2</p><p>きいろいユリ x2</p><p>しろいユリ x2",image: "CapOrnamentYuri1",name: "ユリのかんむり",get: get8},
    {category: 5,series: 99,obtain: 8,make: "ピンクのユリ x2</p><p>オレンジのユリ x2</p><p>しろいユリ x2",image: "CapOrnamentYuri2",name: "ユリのかんむり・キュート",get: get8},
    {category: 5,series: 99,obtain: 8,make: "くろいユリ x6",image: "CapOrnamentYuri3",name: "ユリのかんむり・ダーク",get: get8},
    ...
    {category: 0,series: 99,obtain: 13,make: "あかいチューリップ x1</p><p>ほしのかけら x3",image: "ToolStickTulip",name: "チューリップのステッキ",get: get13},
    {category: 0,series: 99,obtain: 13,make: "あかいバラ x1</p><p>ほしのかけら x3",image: "ToolStickRose",name: "バラのステッキ",get: get13},
    {category: 0,series: 99,obtain: 13,make: "きいろいパンジー x1</p><p>ほしのかけら x3",image: "ToolStickPansy",name: "パンジーのステッキ",get: get13},
    {category: 0,series: 99,obtain: 13,make: "ピンクのヒヤシンス x1</p><p>ほしのかけら x3",image: "ToolStickHyacinth",name: "ヒヤシンスのステッキ",get: get13},
    {category: 0,series: 99,obtain: 13,make: "しろいユリ x1</p><p>ほしのかけら x3",image: "ToolStickYuri",name: "ユリのステッキ",get: get13},
